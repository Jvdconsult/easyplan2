...
const generateTimeSlots = () => {
  ...
  for (let hour = 0; hour < 24; hour += 2) {
    const startTime = format(new Date().setHours(hour, 0), 'HH:mm');
    const endTime = format(new Date().setHours(hour + 2, 0), 'HH:mm');
      ...
      <div className="bg-gray-800/90 backdrop-blur border border-white/10 rounded-xl w-full max-w-2xl shadow-xl">
        ...
        <div className="p-4 border-t border-white/10 flex justify-end space-x-3">
          ...
          <button
            ...
            className="px-4 py-1.5 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-lg font-medium hover:from-blue-600 hover:to-purple-600 transition-all duration-200 shadow-lg shadow-blue-500/25"
          >
            Create Event
          </button>
        </div>
